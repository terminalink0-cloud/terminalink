...
export class TripsService {
  ...
  //        └─ Municipality QueueEntry
  // ==========================================================

  // ==========================================================
// CREATE TRIP
//
// A newly created trip immediately gets:
//
// Trip
//   ↓
// OUTBOUND TripLeg
...
// Municipality QueueEntry
//
// This makes the trip immediately visible to the driver.
// ==========================================================
...
async create(
  ...
  if (
    ...
    throw new BadRequestException(
      "Vehicle must belong to the driver's cooperative",
    );
  }
  ...
  // ==========================================================
  // VERIFY ROUTE / MUNICIPALITY
  //
  // For an OUTBOUND trip, the municipality is the origin.
  // ==========================================================
  ...
  if (
    ...
    throw new BadRequestException(
      "Municipality must match the route origin for an OUTBOUND trip",
    );
  }
  ...
  return this.prisma.$transaction(
    async (tx) => {
      ...
      // ------------------------------------------------------
      // FIND NEXT MUNICIPALITY QUEUE POSITION
      //
      // Queue is scoped by cooperative.
      // Cooperative A can have #1 while Cooperative B
      // can also have #1.
      // ------------------------------------------------------
      ...
      // ------------------------------------------------------
      // CREATE MUNICIPALITY QUEUE ENTRY
      // ------------------------------------------------------
  ...
  //
  // New code should complete the CURRENT TripLeg.
  // ==========================================================
  ...
  async completeTrip(
    ...
    if (
      ...
      throw new BadRequestException(
        "Trip must have arrived before completion",
      );
    }
