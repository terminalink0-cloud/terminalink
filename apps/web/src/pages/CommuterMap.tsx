...
export default function CommuterMap() {
  ...
  <aside className="absolute bottom-0 left-0 right-0 z-[1000] flex max-h-[80vh] flex-col rounded-t-2xl bg-white shadow-2xl dark:bg-slate-900 sm:bottom-4 sm:left-auto sm:right-4 sm:max-h-[calc(100vh-2rem)] sm:w-[min(400px,calc(100%-2rem))] sm:rounded-2xl">
    {/* Sticky header with close button */}
    <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-gray-100 bg-white px-5 py-4 dark:border-slate-800 dark:bg-slate-900">
      <div>
        <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 text-2xl font-bold text-gray-600 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
        aria-label="Close"
      >
        ×
      </button>
